...
export default function useGetProductsWithQuery(
  slug?: string,
  page = 1,
  filters?: Filters,
  limit = 10
  ...
  //       params.append(
  //         "brand",
  //         filters.brand.map((brand) => brand.name).join(",")
  //       );
  //     }
  ...
  //       params.append(
  //         "features",
  //         filters.features.map((feature) => feature.name).join(",")
  //       );
  //     }
